...
describe ModBus::TCPServer do
  ...
  it "succeeds if UID is broadcast" do
  ...
  it "sends exception if quanity of registers are more than 0x7d" do
  ...
  it "does not send exception if quanity of coils are more than 0x7d0" do
  ...
  it "sends exception if addr not valid" do
  ...
  it "supports function 'read coils' with more than 125 in one request" do
